...
class TeleportationCircuitGenerator:
    ...
    """
    def __init__(self, protocol=None, payload_size: int = 3, gates: list | int = None, use_barriers: bool = True, save_statevector: bool = False, protocol_type: str = 'variation'):
        self.gates = {}
        ...
        if protocol is not None:
            ...
            raise ValueError(f"Unknown protocol_type: {protocol_type}. Use 'standard' or 'variation'")
