...
\item \textbf{Quantum Forecasting Framework:} A software tool that integrates metric extraction, footprint validation, and ML-based prediction into a unified pipeline, as described in Section~\ref{section:qaqs} and Figure~\ref{fig:framework-overview}.
\label{c:framework}
...
\begin{longtable}{@{}p{\textwidth}@{}}
    ...
    \textit{Estimation:} 1 Month \newline
    \textbf{Related Goals:} Hypothesis \ref{h:1}, Objective \ref{o:1} \newline
    \textbf{Description:} Define the "Quantum Circuit Footprint" feature vector by running a correlation by running a correlation and contribution analysis. \newline
    \textbf{Tasks:}
