"""
QWARD Teleportation Example

This example demonstrates the separation between circuit generation
...
def main():
    ...
    print("  • Use QuantumCircuitExecutor: executor.simulate(generator.circuit, ...)")
